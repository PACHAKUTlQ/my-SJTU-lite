...
public class ProfileDto {
    private ProfileEntityDto[] entities;
    private long errno;
    private String error;
    private long total;

    @JsonProperty("entities")
    public ProfileEntityDto[] getEntities() { return entities; }
    @JsonProperty("entities")
    public void setEntities(ProfileEntityDto[] value) { this.entities = value; }
